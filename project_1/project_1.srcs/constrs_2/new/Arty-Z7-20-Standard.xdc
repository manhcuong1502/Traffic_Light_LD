...
set_property IOSTANDARD LVCMOS33 [get_ports {A_lights[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {A_lights[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {B_lights[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {B_lights[0]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {A_lights[2]}]
